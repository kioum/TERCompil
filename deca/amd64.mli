...
val cmove : [< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovne :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovs :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovns :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovg :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovge :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovl :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovle :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmova :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovae :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovb :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text
val cmovbe :[< ([< `w | `l | `q ] as 'a) dest ] operand -> [< 'a reg ] operand -> text

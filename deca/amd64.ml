...
let cmove (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmove %s, %s" s d

let cmovne (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovne %s, %s" s d

let cmovs (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovs %s, %s" s d

let cmovns (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovns %s, %s" s d

let cmovg (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovg %s, %s" s d

let cmovge (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovge %s, %s" s d

let cmovl (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovl %s, %s" s d

let cmovle (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovle %s, %s" s d

let cmova (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmova %s, %s" s d

let cmovae (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovae %s, %s" s d

let cmovb (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovb %s, %s" s d

let cmovbe (s : 'size source operand) (d : 'size dest operand) : text =
  ins "cmovbe %s, %s" s d
